...
Rectangle {
    ...
    property string downloadTotalSize: ""
    property string downloadStatus: "Starting..."
    ...
    ListModel {
        id: videoFormatsModel
    }
    ListModel {
        id: audioFormatsModel
    }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    color: "white"
                    onTextChanged: {
                        root.showStatus = text.length > 0;
                        var validationResult = root.validateYouTubeUrl(text);
                        root.isValid = validationResult.isValid;
                        root.contentType = validationResult.type;
                ...
                RowLayout {
                    ...
                    spacing: 5
                    Image {
                        source: root.isValid ? "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24'><path fill='%234CAF50' d='M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z'/></svg>" : "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24'><path fill='%23c23628' d='M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z'/></svg>"
                    }
                    Label {
                        text: root.isValid ? "Type: " + root.contentType : "Invalid link!"
                        color: root.isValid ? "#4CAF50" : "#c23628"
                        font.pixelSize: 11
                    }
                }
            }
            StyledButton {
                ...
                Layout.alignment: Qt.AlignTop
                Layout.topMargin: -7
                enabled: root.isValid && !root.isLoading
                onClicked: {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            ...
                            color: "#bbbbbb"
                            wrapMode: Text.WordWrap
                            visible: root.contentType !== "youtube music"
                        }
                        Text {
                            id: durationText
                            font.pixelSize: 12
                            ...
                            ListView {
                                ...
                                delegate: Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Text {
                                            text: model.vcodec + ", " + model.acodec
                                            color: "white"
                                            elide: Text.ElideRight
                                            verticalAlignment: Text.AlignVCenter
                                            Layout.fillWidth: true
                            ...
                            ListView {
                                ...
                                delegate: Rectangle {
                                    ...
                                    RowLayout {
                                        anchors.fill: parent
                                        Text {
                                            text: Math.round(model.abr) + " kbps"
                                            color: "white"
                                            elide: Text.ElideRight
                                            verticalAlignment: Text.AlignVCenter
                                            Layout.preferredWidth: 80
                ...
                Rectangle {
                    ...
                    color: "#333333"
                    radius: 5
                    visible: root.selectedVideoFormat || root.selectedAudioFormat || root.isDownloading
                        ...
                        ColumnLayout {
                            ...
                            StyledButton {
                                ...
                                onClicked: {
                                    ...
                                    root.downloadStatus = "Initializing...";
                            ...
                            Text {
                                text: "<b>Estimated Size:</b> " + formatSize(root.totalSizeInBytes)
                                Layout.alignment: Qt.AlignRight
                                color: "white"
                                font.pixelSize: 13
                                font.bold: true
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                ProgressBar {
                                    ...
                                    value: root.downloadProgressValue
                                    Material.accent: "#c23628"
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    Text {
                                        text: Math.round(root.downloadProgressValue * 100) + "%"
                                        color: "#aaaaaa"
                                        font.pixelSize: 10
                                    }
                                    Item {
